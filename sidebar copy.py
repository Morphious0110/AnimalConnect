...
def create_sidebar(root):
    ...
    menu_items = [
        ("Volunteer", "home_icon.png", "Volunteer"),
        ("Donation", "lecture_icon.png", "lecture_page"),
        ("Adoption", "user_icon.png", "teacher_section"),
        ("Rescue", "teacher_icon.png", "Rescue"),
    ]
    ...
    for item in menu_items:
        ...
        button = Button(sidebar, text=item[0], image=photo_image, compound=LEFT, fg="white", bg="#eb4163", bd=0, padx=20,
                        pady=10, anchor="w", command=lambda page=item[2]: open_page(page))
